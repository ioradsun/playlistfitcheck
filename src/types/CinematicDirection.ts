...
/** @deprecated — replaced by typographyPlan */
...
export interface CinematicDirection {
  ...
  sceneTone?: string;
  /** @deprecated — never generated by current AI prompt */
  atmosphere?: string;
  /** @deprecated — never generated by current AI prompt */
  motion?: string;
  /** @deprecated — never consumed by renderer */
  typography?: string;
  /** @deprecated — use typographyPlan via fontResolver instead */
...
export interface CinematicSection {
  sectionIndex: number;
  description: string;
  /** @deprecated — use visualMood instead */
  mood?: string;
  /** Visual mood keyword from fixed vocabulary — drives cinematic grading */
  visualMood?: string;
  /** @deprecated — deleted by validation, never consumed */
  motion?: string;
  texture?: string;
  /** @deprecated — deleted by validation, never consumed */
  typography?: string;
  ...
  /** @deprecated — never generated by AI */
  suggestedStartSec?: number;
  /** AI boundary suggestion — only present for low-confidence sections */
  /** @deprecated — never generated by AI */
  suggestedEndSec?: number;
  /** How particles behave in this section */
  /** @deprecated — never generated by AI, never fires in player */
