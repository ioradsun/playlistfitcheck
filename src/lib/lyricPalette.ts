...
const MOOD_PALETTES: Record<string, string[]> = {
  ...
  ethereal: ["#080A14", "#A8C4E0", "#E8F0F8", "#C4D8F0", "#5A7090"],
  haunted: ["#0A0A0F", "#5A6B7A", "#D8DDE2", "#7A8B9A", "#3A4550"],
  celestial: ["#080810", "#7B8EC4", "#E0E4F0", "#9AAAD4", "#4A5678"],
  eerie: ["#050F0A", "#00BFA5", "#E0F5F0", "#00FFCC", "#1A5A4A"],
  noir: ["#0A0A0A", "#4A5568", "#D0D4DA", "#6A7080", "#2A3038"],
  rebellious: ["#140505", "#C44E2B", "#F8E6E0", "#E06840", "#7A2A15"],
