      ...
      <div className="relative flex flex-row h-full">
        ...
        >
          ...
          {getBorderStyle("a").boxShadow && (
            <div className="absolute top-0 left-0 right-0 bottom-12 z-10 pointer-events-none rounded-sm" style={getBorderStyle("a")} />
          )}
        ...
        {hookB ? (
          ...
          >
            ...
            {getBorderStyle("b").boxShadow && (
              <div className="absolute top-0 left-0 right-0 bottom-12 z-10 pointer-events-none rounded-sm" style={getBorderStyle("b")} />
            )}
