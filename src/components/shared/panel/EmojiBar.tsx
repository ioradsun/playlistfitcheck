        ...
        {EMOJIS.map(({ key, symbol, label }) => {
          ...
          return (
            <button
              ...
              style={{
                background: hasReacted ? `${palette?.[1] ?? '#ffffff'}12` : 'transparent',
            ...
            >
              ...
              <span
                ...
                style={{
                  opacity: count > 0 ? 1 : 0,
                  color: hasReacted ? (palette?.[1] ?? 'rgba(255,255,255,0.8)') : 'rgba(255,255,255,0.35)',
                }}
              >
                {count || 0}
              </span>
      ...
      {EMOJIS.map(({ key, symbol }) => {
        ...
        return (
          <button
            ...
            style={{
              background: hasReacted ? `${palette?.[1] ?? '#ffffff'}15` : 'transparent',
