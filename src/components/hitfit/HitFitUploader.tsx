              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="top" className="text-xs max-w-[220px]">{slot.desc} · MP3, WAV, M4A · 25 MB max · Not saved or stored</TooltipContent>
                  </Tooltip>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-2">
                <p className="text-sm font-semibold">Reference Track</p>
                 ...
                 <Tooltip>
                  ...
                  <TooltipContent side="top" className="text-xs max-w-[220px]">A released track with the sound you're targeting · MP3, WAV, M4A · 25 MB max · Not saved or stored</TooltipContent>
                </Tooltip>
              </div>
            </div>
          </div>
