...
function LazySpotifyEmbedInner({ trackId, trackTitle, trackUrl, postId, albumArtUrl, artistName, cardState: _cardState }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 bg-black pointer-events-none z-20" style={{ height: 10 }} />
      <div className="absolute bottom-0 left-0 right-0 bg-black pointer-events-none z-20" style={{ height: 10 }} />
      {iframeLoaded && (
