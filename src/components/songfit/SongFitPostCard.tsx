            ...
            <div className="pointer-events-auto bg-gradient-to-t from-black/90 via-black/50 to-transparent pt-16 px-4 pb-[calc(0.75rem+env(safe-area-inset-bottom,0px))]">
              <div className="flex items-center gap-2 mb-2">
                <div
                  ...
                  onClick={handleProfileClick}
                >
                  <div className={cn("h-9 w-9 rounded-full bg-white/10 flex items-center justify-center overflow-hidden ring-1", (post.profiles as any)?.is_verified ? "ring-green-400" : "ring-white/10")}>
                    {post.profiles?.avatar_url ? (
                      <img src={post.profiles.avatar_url} alt="" className="w-full h-full object-cover" />
                    ) : (
