...
export type PipelineStageTimes = Partial<Record<keyof PipelineStages, number>>;
...
export function LyricFitTab({
  ...
  const restartImages = useCallback(() => {
    ...
    // Images are generated by CinematicDirectionCard in FitTab — signal via status change
