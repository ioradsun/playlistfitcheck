...
export function FitExportModal({ isOpen, onClose, getPlayer, songTitle, artistName, clipStart, clipEnd, captionText }: Props) {
  ...
  }, [getPlayer, quality, ratio, resetState, clipStart, clipEnd, captionText]);
